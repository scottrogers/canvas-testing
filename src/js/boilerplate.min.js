...
App.Canvas = (function(_super) {
  ...
  Canvas.prototype.animationLoop = function(time) {
    setTimeout((function() {
      window.requestAnimFrame(this.animationLoop(time));
      this.flickerColoring(time);
    }), 1000 / this.fps);
  };
  ...
  Canvas.prototype.flickerColoring = function() {
    while (this.i < this.rows) {
      ...
      while (this.j < this.columns) {
        this.draw(this.j * boxSize["width"], this.i * this.boxSize["height"], this.colorList[j]["value"]);
        this.j++;
      }
      this.i++;
    }
